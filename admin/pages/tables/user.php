        ...
        <section class="content">
         ...
         <form class="form-inline">
				...
				<div class="form-group">
					...
					<option value="jenis_usaha">Jenis Usaha
					</select>
				...
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								<a href="index.php?aksi=delete&nis='.$row['id_user'].'" title="Hapus Data" onclick="return confirm(\'Yakin Ingin Menghapus?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
