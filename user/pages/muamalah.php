...
<html>
  <head>
    ...
    <title> User UMKM | Muamalah </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../index2.html" class="logo">
          ...
          <span class="logo-mini"><b>U</b>UKM</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>User</b>UMKM</span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class=" treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="../pages/tables/bmt.php"><i class="fa fa-circle-o"></i> Lihat</a></li>
                    <li><a href="../pages/tables/add_bmt.php"><i class="fa fa-circle-o"></i> Tambah </a></li>
                  </ul>
                </li>
           <li class=" treeview">
              <a href="#">
